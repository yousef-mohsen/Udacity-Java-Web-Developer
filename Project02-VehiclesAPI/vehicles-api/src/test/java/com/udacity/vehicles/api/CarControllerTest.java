...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        Car car = getCar();
        mvc.perform(
                        get("/cars")).andExpect(jsonPath("$..carList[0].details.model").value(car.getDetails().getModel()))
               .andExpect(jsonPath("$..carList[0].details.manufacturer.code").value(car.getDetails().getManufacturer().getCode()))
               .andExpect(jsonPath("$..carList[0].details.manufacturer.name").value(car.getDetails().getManufacturer().getName())).andExpect(status().isOk())
        ;
    ...
    public void findCar() throws Exception {
        ...
        Car car = getCar();
        mvc.perform(
                        get("/cars/1")).andExpect(jsonPath("$.details.model").value(car.getDetails().getModel()))
